...
echo "   • Redis Cache: 1 узел (standalone)"
echo ""
echo "🔍 Полезные команды:"
echo "   • Статус кластера MongoDB:"
...
echo "     docker compose exec redis_1 redis-cli ping"
echo "     docker compose exec redis_1 redis-cli info stats"
echo ""
